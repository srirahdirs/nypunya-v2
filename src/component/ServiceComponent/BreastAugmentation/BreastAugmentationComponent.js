  ...
  return (
    <div className="container mx-auto py-10 px-4">
      ...
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-custom-blue">Breast Augmentation</h2>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2">
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            {breastServiceContent[0].content.map((detail, index) => (
          ...
          <div className="space-y-6">
            ...
            >
              <img
                ...
                alt="Featured Breast Augmentation"
                className="w-full h-[400px] object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent">
                <div className="absolute bottom-6 left-6 text-white">
                  <h3 className="text-2xl font-bold mb-2">Breast Augmentation</h3>
            ...
            <div className="grid grid-cols-3 gap-4">
              {informationImages.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Breast Augmentation ${index + 1}`}
      ...
      {isModalOpen && (
        ...
        >
          <div className="relative w-full h-full flex items-center justify-center p-4">
            <img
              src={informationImages[selectedImage]}
              alt={`Breast Augmentation ${selectedImage + 1}`}
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white text-lg">
              Step {selectedImage + 1} of {informationImages.length}
            </div>
          </div>
        </div>
      )}
