...
const Faqanti_ageing = () => {
    const [selectedVideo, setSelectedVideo] = useState(null);

    const videos = [
        {
            id: "video1",
            thumbnail: "/services/anti_ageing/faq/1.jpg",
            videoId: "BFUANRQsbT0",
            title: "Anti-Ageing Video 1"
        },
        {
            id: "video2",
            thumbnail: "/services/anti_ageing/faq/1.jpg",
            videoId: "ALlF4HyWeqs",
            title: "Anti-Ageing Video 2"
        },
        {
            id: "video3",
            thumbnail: "/services/anti_ageing/faq/1.jpg",
            videoId: "wDnSme1y6Ys",
            title: "Anti-Ageing Video 3"
        },
        {
            id: "video4",
            thumbnail: "/services/anti_ageing/faq/1.jpg",
            videoId: "wDnSme1y6Ys",
            title: "Anti-Ageing Video 4"
        },
    ];
