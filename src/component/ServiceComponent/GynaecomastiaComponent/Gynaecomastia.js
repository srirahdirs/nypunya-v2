...
import { GynaecomastiaData } from "../../../utils/ServiceDatas/GynaecomastiaData/gynaecomastiaData"; // Adjust path if needed
      ...
      <div className="flex flex-col lg:flex-row lg:gap-8 gap-5 w-full">
        ...
        <div className="lg:w-1/2 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {GynaecomastiaData.map((item, index) => (
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center pt-0 lg:pt-10">
          <div className="relative w-full max-w-md lg:max-w-full">
            <img
              src="/services/gynaecomastia/gynaecomastia_service.png"
