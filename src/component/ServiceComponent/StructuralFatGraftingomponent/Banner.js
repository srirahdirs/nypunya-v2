    ...
    <>
      <div className="relative w-full md:h-[600px] h-[450px]">
        ...
        <div className="absolute inset-0">
          <img
            src="/services/structural_fat_grafting/structural_fat_grafting_banner.png"
            alt="About Us Banner"
        ...
        <div className="absolute inset-0 flex flex-col justify-end items-center text-white">
          <h1 className="md:text-6xl text-3xl font-bold pb-32 text-center">Structural Fat Grafting</h1>
        </div>
      </div>
