...
import { StructuralFatGraftingData } from "../../../utils/ServiceDatas/StructuralFatData/StructuralFatData"; // Adjust path if needed
      ...
      <div className="flex flex-col lg:flex-row lg:gap-8 gap-5 w-full">
        ...
        <div className="lg:w-1/2 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {StructuralFatGraftingData.map((item, index) => (
