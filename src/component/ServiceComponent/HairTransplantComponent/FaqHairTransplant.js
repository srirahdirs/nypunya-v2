...
const FaqHairTransplant = () => {
    const [selectedVideo, setSelectedVideo] = useState(null);

    const videos = [
        {
            id: "video1",
            thumbnail: "/services/hair_transplant/faq/1.jpg",
            videoId: "gpjLiVqXt90",
            title: "Hair Transplant Video 1"
        },
        {
            id: "video2",
            thumbnail: "/services/hair_transplant/faq/1.jpg",
            videoId: "uWuw8cRqFIs",
            title: "Hair Transplant Video 2"
        },
        {
            id: "video3",
            thumbnail: "/services/hair_transplant/faq/1.jpg",
            videoId: "krpPWXKJ-HM",
            title: "Hair Transplant Video 3"
        },
    ];
...
export default FaqHairTransplant; 