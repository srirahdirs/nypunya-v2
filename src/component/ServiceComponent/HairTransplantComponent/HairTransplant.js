  ...
  return (
    <div className="container mx-auto py-10 px-4">
      ...
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-custom-blue">Hair Transplant</h2>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2">
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            {hairTransplantDetails.map((detail, index) => (
          ...
          <div className="space-y-6">
            ...
            >
              <img
                ...
                alt="Featured Hair Transplant"
                className="w-full h-[400px] object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent">
                <div className="absolute bottom-6 left-6 text-white">
                  <h3 className="text-2xl font-bold mb-2">Hair Transplant</h3>
      ...
      {isModalOpen && (
        ...
        >
          <div className="relative w-full h-full flex items-center justify-center p-4">
            <img
              src={informationImages[selectedImage]}
              alt={`Hair Transplant ${selectedImage + 1}`}
