        ...
        <>
            <div className="relative w-full md:h-[600px] h-[450px]">
                ...
                <div className="absolute inset-0">
                    <img
                        src="/services/laser-tattoor-emoval/laser_tattoo_removal_banner.png"
                        alt="About Us Banner"
                ...
                <div className="absolute inset-0 flex flex-col justify-end items-center text-white">
                    <h1 className="md:text-6xl text-3xl font-bold pb-32 text-center">Laser Tattoo Removal</h1>
                </div>
            </div>
