...
import { LiposuctionComponentData, galleryImages, informationImages } from "../../../utils/ServiceDatas/LiposuctionComponentData/LiposuctionComponentData";

const LiposuctionComponent = ({ scrollTo }) => {
  ...
  return (
    <div className="container mx-auto py-10 px-4">
      ...
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-custom-blue">Liposuction </h2>
          ...
          {images.length > 0 && (
            ...
            >
              <img
                ...
                alt="Featured LiposuctionComponent"
                className="w-full h-[600px] object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent">
                <div className="absolute bottom-6 left-6 text-white">
                  <h3 className="text-2xl font-bold mb-2">Liposuction </h3>
            ...
            <div className="flex justify-center gap-4 overflow-x-auto pb-4">
              {images.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`LiposuctionComponent ${index + 1}`}
      ...
      {isModalOpen && images.length > 0 && (
        ...
        >
          <div className="relative w-full h-full flex items-center justify-center p-4">
            <img
              src={images[selectedImage]}
              alt={`LiposuctionComponent ${selectedImage + 1}`}
...
export default LiposuctionComponent;
