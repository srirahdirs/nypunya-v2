...
import { galleryImages } from "../../../utils/ServiceDatas/LiposuctionComponentData/LiposuctionComponentData"; // Importing gallery images
...
const GalleryComponent = () => {
    ...
    const handleViewMore = () => {
        navigate('/gallery', { state: { category: 'Liposuction' } });
    };
