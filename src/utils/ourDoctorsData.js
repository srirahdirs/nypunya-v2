...
export const team = [
    {
        ...
        title: "Diabetic Foot Care Specialist",
        image: "/our-doctors/doctor_pradeep_kumar_n.jpeg",
        icon: {
            svg: `<svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6l4 2" /><circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2" fill="none" /></svg>`
        },
        description:
...

    {
        name: "Dr. Maansa",
        title: "Dermatologist",
        image: "/our-doctors/doctor_maanasa.jpeg",
