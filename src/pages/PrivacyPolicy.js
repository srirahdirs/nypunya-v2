...
const PrivacyPolicy = () => (
    <div className="privacy-container" style={{ maxWidth: 1200, margin: '0 auto', padding: '48px 40px', background: '#fff', borderRadius: 16, boxShadow: '0 4px 24px #0001', lineHeight: 1.8 }}>
        ...
        <p style={{ marginBottom: 16 }}><b>2.1 Dental Services:</b> Nypunya Aesthetic Clinic provides information about dental services on our Website. Please contact us directly to schedule an appointment or for detailed information about specific services.</p>
